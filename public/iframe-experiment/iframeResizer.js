  ...
  function iFrameListener(event) {
    ...
    function processMsg() {
      ...
      return {
        iframe: iframe,
        id: data[0],
        //TODO: Added +30 by Bentley so that y scroll bars do not display when X scroll bar displays
        height: height + getPaddingEnds(compStyle) + getBorderEnds(compStyle) + 30,
        width: data[2],
        type: data[3]
      }
    }
