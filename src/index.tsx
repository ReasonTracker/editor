...
import { Repository, CalculationInitator, Change, Claim, ClaimEdge, ID, Affects, Messenger } from "@reasonscore/core";
...
calculationInitator.notify([
  ...
  new Change(new ClaimEdge(topClaim.id, increaseTraffic.id, Affects.Confidence, false,ID("TrafficEdge"))),
